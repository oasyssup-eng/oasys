  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <p className="text-orange-400 text-center text-sm font-medium mb-1">
          Kitchen Display
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            ...
            <button
              ...
              className="h-16 rounded-xl bg-orange-600 text-white text-sm font-bold hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {isLoading ? '...' : 'Entrar'}
            </button>
          </div>
